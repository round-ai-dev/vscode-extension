...
*/
  ...
  LGraphNode.prototype.serialize = function () {
    ...
    if (this.widgets && this.serialize_widgets) {
      ...
      if (!o.widgetParameter) {
        o.widgetParameter = {}; // widgetParameter가 정의되지 않은 경우 초기화
      }
      for (var i = 0; i < this.widgets.length; ++i) {
        o.widgetParameter[this.widgets[i].name] = this.widgets[i].value;
      }
    }
  ...
  LGraphNode.prototype.connectByTypeOutput = function (
    ...
    source_slot = source_node.findOutputSlotByType(
      source_slotType,
      false,
      true,
    );
...
*/
   ...
   * @param {Object} vscode [optional]
   */
  function LGraphCanvas(canvas, graph, options, vscode) {
  ...
  LGraphCanvas.prototype.drawButton = function (
    ...
    var clicked =
      pos && LiteGraph.isInsideRectangle(pos[0], pos[1], x, yFix, w, h);
